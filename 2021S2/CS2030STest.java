...
class CS2030STest {
   ...
   * @return this object.
   */
  public <T> CS2030STest expect(String test, Producer<T> task, Object expect) {
    System.out.print(test);
    try {
   ...
   * @return this object.
   */
  public <T> CS2030STest expectReturn(String test, Producer<T> task, Object expect) {
   ...
   * @return this object.
   */
  public CS2030STest expectException(String test, Runnable task, Throwable expectedE) {
    ...
    if (gotException) {
      ...
      if (caught != null) {
        System.out.println("  caught this instead " + caught.getClass());
      }
    }
    return this;
  }

  public CS2030STest expectException(String test, Runnable task, Throwable expectedE, String msg) {
    System.out.print(test + " throws " + expectedE.getClass().getSimpleName());
    boolean gotException = false;
